...
def save_visualized_image(image: np.ndarray, image_id: int, ocr_result: list, output_folder: str) -> None:
...
def detect_text_multiple_images(images: list[np.ndarray], ocr_object, file_name: str, save_dir: str) -> None:
